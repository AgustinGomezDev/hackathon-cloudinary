...
export default function Home() {
  ...
  return (
    <div className='h-[30rem] lg:h-[40rem] flex gap-10 flex-col justify-center items-center'>
      ...
      <CloudinaryWidget />
      <p className="text-xs lg:text-sm text-balance text-gray-400 text-center max-w-xs md:max-w-lg">Para que el resultado sea óptimo, asegúrate de subir una imagen clara y de buena calidad, donde se le/te reconozca bien. ¡Así tu transformación será aún más sorprendente! (en ciertos casos aunque la imagen sea la correcta la IA puede fallar en su modificación)</p>
    </div>
  );
}
